...
// Support both naming conventions: with and without _CLOUD_ prefix
const API_KEY = process.env.CLOUDINARY_API_KEY || process.env.CLOUDINARY_CLOUD_API_KEY;
const API_SECRET = process.env.CLOUDINARY_API_SECRET || process.env.CLOUDINARY_CLOUD_API_SECRET;
